"""
Django settings for outprints project.
...
SECRET_KEY = 'django-insecure-=4qqvh@q1=s_yl=e@)p0j(k#+sar09er#os5m6gu*cye3!(ay*'
...
WSGI_APPLICATION = 'outprints.wsgi.application'
